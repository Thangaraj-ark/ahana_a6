...
@NgModule({
    ...
    declarations: [LayoutComponent, SidebarComponent, HeaderComponent, TexteditorComponent, CalendarComponent, RolesComponent, DataTableComponent, ConfigurationComponent, InnerHeaderComponent, CreateRoleComponent, UpdateRoleComponent, RoleRightsComponent, SpecialitiesComponent, CreateSpecialityComponent, UpdateSpecialityComponent, PatientCategoriesComponent]
})
